          ...
          {Data.data.type === 2 ? (
              ...
              <>
                ...
                <h3 className="font-semibold">{Data.description}</h3> */}
                  {/* <Link
									...
									> */}
                  <a
                    href={`https://dl.vid3konline.workers.dev/api/download?type=.mp4&title=Reels-(snapinsta.org)${Math.floor(
                      Math.random() * 100000000000,
                ...
                <a href="https://snapinsta.org/reels">
            ...
            <>
              ...
              <div className="flex items-center justify-center h-auto p-2 m-auto ">
                ...
                <a
                  href={`https://dl.vid3konline.workers.dev/api/download?type=.png&title=${Math.floor(
                    Math.random() * 100000000000,
              ...
              <a href="https://snapinsta.org/photo">
                <div className="flex items-center justify-center mx-4 my-2">
                      ...
                      return (
                        <>
                          ...
                          <video
                            ...
                            // 	Math.random() * 100000000000
                            // )}`}
                            src={`https://dl.vid3konline.workers.dev/api/download?type=.mp4&title=${Math.floor(
                              Math.random() * 100000000000,
                          ...
                          <div className="flex items-center justify-center h-auto m-auto ">
                            ...
                            {/* <Link
												...
												> */}
                            <a
                              href={`https://dl.vid3konline.workers.dev/api/download?type=.mp4&title=${Math.floor(
                                Math.random() * 100000000000,
                              )}&url=${encodeURIComponent(ee.url.replaceAll("https://phosphor.ivanenko.workers.dev/?url=", ""))}`}
                              target="_blank"
                              download
                    ...
                    (
                      ...
                      return (
                        <>
                          ...
                          <img
                            className="h-full m-auto bg-gray-500 border-2 border-gray-200 rounded-lg w-72 dark:border-gray-700 "
                            src={`https://dl.vid3konline.workers.dev/api/download?url=${encodeURIComponent(
                              ee.url,
                            )}&type=${".png"}&title=${Math.floor(
                              Math.random() * 100000000000,
                            )}`}
          ...
          {Data.data.map((storyUrl: any) => {
            ...
            return storyUrl.media_type == 1 ? (
              <div key={storyUrl.url}>
                <img
                  className="h-full m-auto bg-gray-500 border-2 border-gray-200 rounded-lg w-72 dark:border-gray-700 "
                  src={`${storyUrl.url.replaceAll("https://phosphor.ivanenko.workers.dev/?url=", "")}`}
                  onLoad={() => setLoading(false)}
                />
